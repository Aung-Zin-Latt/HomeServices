                ...
                <div class="container">
                    <div class="portfolioContainer">
                        ...
                        @if (!$scategory->services->count() > 0)
                            <div class="col-md-12">
                                <strong><p class="text-center" style="font-size: 1rem;">There is no services.</p></strong>
                            </div>
                        @endif
                                ...
                                <a class="g-list" href="service-details/ac-wet-servicing.html">
                                    ...
                                    <div class="info-gallery">
                                        ...
                                        <div class="content-btn">
                                            <a href="service-details/ac-wet-servicing.html" class="btn btn-primary">Book Now</a>
                                        </div>
